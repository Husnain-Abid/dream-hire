    ...
    <div className="min-h-screen container mx-auto  py-12 px-4 ">
      ...
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-gray-900">
          ...
          <span className="text-blue-600 italic">best price</span>
        </h1>
      </div>
              ...
              <div className="flex items-center justify-between gap-2 mb-2">
                <plan.icon
                  className={`w-6 h-6   fill-[#5865F2] ${
                    key === "free" ? "text-white" : "text-white"
                  }`}
                />

                {key === "free" && (
                  <span className="inline-block bg-[#EBECFC] text-blue-600 text-xs px-3 py-1 rounded-full">
                    Free Trial (14 days)
                  </span>
                )}
              </div>
