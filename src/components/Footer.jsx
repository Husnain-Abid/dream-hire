  ...
  return (
    <footer className=" md:mx-16 font-ppneuemontreal ">
      ...
      <div className=" container mx-auto " >
        {/* Main Footer Links */}
        <div className="grid gap-8 font-normal sm:grid-cols-2 lg:grid-cols-4 mb-12">
        ...
        {/* Bottom Links */}
        <div className="flex flex-col gap-32 sm:flex-row sm:items-center sm:justify-start text-sm font-medium text-white">
          <div>
            <p>DreamHire Global Inc.</p>
          </div>
          <div className="flex flex-wrap gap-4">
            {legalLinks.map((link) => (
              <Link key={link} href="#" className="text-sm font-medium hover:text-gray-200  transition-colors">
                {link}
              </Link>
            ))}
          </div>
