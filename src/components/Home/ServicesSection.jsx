...
const ServicesSection = () => {
  ...
  return (
    <div className="container mx-auto px-4 my-10  py-16 space-y-20">
      {/* Services Section */}
      <div>
        <h2 className="text-xl font-medium text-gray-900 mb-12">DreamHire go-to services</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-sm font-medium text-center text-gray-900 group-hover:text-blue-600 transition-colors">
                {service.title}
              </h3>
            </a>
          ))}
      ...
      <div>
        ...
        <div className="flex justify-center">
          <button className="bg-[#5865F2] text-white px-8 py-3 text-sm rounded-lg text-lg font-medium hover:bg-blue-500 transition-colors">
            Get Started
          </button>
        </div>
      </div>
