...
export default function HomeBanner() {
  ...
  return (
    ...
    <div
  className="relative flex justify-center items-end min-h-[200px] md:min-h-[400px] container mx-auto my-16 bg-gradient-radial from-[#6366F1] to-[#5558E3] border rounded-2xl px-4 py-16"
  style={{
...
>
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="mb-8 text-3xl font-medium text-white md:text-5xl lg:text-6xl">
