...
const GuaranteeSection = () => {
    return (
      <div className="container mx-auto  px-4 my-10 sm:px-6 lg:px-8 py-16">
        ...
        <h2 className="text-2xl font-medium text-gray-900 mb-20">Made on DreamHire</h2>
        ...
        <div className="grid md:grid-cols-[150px,1fr] gap-12 items-center">
          ...
          <div className="space-y-4">
            <div className="space-y-0">
              <h3 className="text-3xl font-semibold text-gray-800">100% Money Back Guarantee.</h3>
            ...
            <h4 className="text-3xl font-semibold text-gray-700">Find A Great Worker!</h4>
  
            <a href="#" className="inline-flex items-center text-lg text-blue-600 hover:text-blue-700 transition-colors">
