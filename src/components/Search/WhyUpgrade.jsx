    ...
    <section className="px-4 py-16">
      <div className="container mx-auto grid  md:grid-cols-2 ">
        ...
        <div className="mb-12 max-w-lg">
          <h2 className="mb-4 text-3xl font-light text-[#222325]   md:text-3xl">Why upgrade to DreamHire Pro?</h2>
          ...
          {features.map((feature, index) => (
            <div key={index} >
              <button
                ...
                className="flex w-full items-center justify-between p-4 text-left font-inter"
              >
